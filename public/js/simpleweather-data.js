...
var getWeather = function() {
   ...
   if( $('#weather_2').length > 0 ){
		...
		success: function(weather) {
			...
			//alert(this.id);
			html='<span class="block temprature-icon "><img src="'+document.domain+'/img/weathericons/'+weather.code+'.svg"/></span><h6>'+weather.city+'</h6>';
