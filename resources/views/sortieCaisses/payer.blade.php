...
@endforeach
@php($tva = $sortie->taxe * $total_facture /100)
        ...
        <div class="col-md-12">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Payer Sortie</h6>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-wrap">
                                    <form action="{{ URL::to('/sortieCaisses/'. $sortie->id .'/payer') }}" method="post">
                                        {{ csrf_field() }}
                                        <div class="form-body">
                                            @if(count($errors) > 0)
                                            ...
                                            @endif
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="ref_sortie" name="ref_sortie" class="form-control" value="{{ $sortie->ref }}">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="montant_sortieCaisse" name="montant_sortieCaisse" class="form-control" value="{{ $totalSortieCaisse }}">
                                                            <span class="help-block"> </span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="control-label mb-10" for="montant_restant">Montant Restant</label>
                                                        <input type="text" id="montant_restant" name="montant_restant" class="form-control" value="{{ $net_a_payer - $totalSortieCaisse}}">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group date">
                                                            <input type="text" id="date_entre" name="date_sortieCaisse" class="form-control">
                                                ...
                                                <div class="row moyen-payement moyen-cheque">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label class="control-label mb-10" for="date_sorti">Numero Chéque</label>
