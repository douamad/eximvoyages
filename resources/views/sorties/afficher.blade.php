                    ...
                    <div class="panel-body" style="background-image: url({{ asset('img/clean-exim-logo.jpg') }}); background-repeat: no-repeat; background-position: center;">
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <address class="mb-15">
                                    <span class="address-head mb-5">{{ $sortie->fournisseur->prenom }} {{ $sortie->fournisseur->nom }}</span>
                                    Adresse: {{ $sortie->fournisseur->adresse }} <br>
                                    Email:  {{ $sortie->fournisseur->email }}<br>
                                    Tel: {{ $sortie->fournisseur->telephone }} <br>
                                </address>
                            </div>
                        ...
                        <div class="invoice-bill-table">
                            ...
                            <div class="pull-right">
                                <a href="{{ URL::to('/sortieCaisses/'. $sortie->id ) }}" class="btn btn-success mr-10">
                                    {{ $totalRecu }} Reçu
                                </a>
                                <button type="button" class="btn btn-warning mr-10">
                                    {{ ($tva + $total_sortie) - $totalRecu }} Restant
                                </button>
