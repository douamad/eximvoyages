                                    ...
                                    <tbody>
                                        @foreach ($recus as $recu)
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="btn btn-primary" href="/recus/{{ $recu->id }}/detail">Details</a></td>
                                                <td class="text-nowrap"><a href="/recus/{{ $recu->id }}/modifier" class="mr-25" data-toggle="tooltip" data-original-title="Modifer"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a> <a href="/enrees/{{ $entree->id }}/supprimer" data-toggle="tooltip" data-original-title="Supprimer"> <i class="fa fa-close text-danger"></i> </a> </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
