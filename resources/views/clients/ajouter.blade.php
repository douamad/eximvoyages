        ...
        <div class="col-md-12">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Ajouter Client</h6>
                    </div>
                                            ...
                                            <hr>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label mb-10" for="prenom">Prenom Client</label>
                                                            <input type="text" id="prenom" name="prenom" class="form-control" placeholder="Prenom Client">
                                                            <span class="help-block"> </span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6" style="display: none">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="sigle" name="sigle" class="form-control" placeholder="Sigle Client">
                                                            <span class="help-block"> </span>
                                                        </div>
                                                    </div>
                                                    <!--/span-->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" id="email" name="email" class="form-control" placeholder="Email Client">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label mb-10" for="telephone">Telephone Client</label>
                                                        <input type="text" id="telephone" name="telephone" class="form-control" placeholder="Telephone Client">
                                                    </div>
                                                </div>
                                            </div>
