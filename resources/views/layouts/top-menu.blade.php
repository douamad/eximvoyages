...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <a href="/"><img class="brand-img pull-left" src="{{ asset('img/eximlog.png') }} " alt="brand"/></a>
    <ul class="nav navbar-right top-nav pull-right">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bell top-nav-icon"></i><span class="top-nav-icon-badge" id="tot_new_billet"></span></a>
                    ...
                    <div class="streamline message-box message-nicescroll-bar">
                        <div class="sl-item">
                            ...
                            <div class="sl-content">
                                <a href="{{ URL::to('/billets') }}" class="inline-block capitalize-font  pull-left">
                                    <span id="new_billets"></span> Nouveau Billet</a>
                                <span class="inline-block font-12  pull-right" id="date_new"></span>
