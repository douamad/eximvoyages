                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-wrap">
                                    <form action="{{ URL::to('/entrees/ajouter') }}" method="post">
                                        {{ csrf_field() }}
                                        <div class="form-body">
                                            @if(count($errors) > 0)
                                            ...
                                            @endif
                                                ...
                                                <div class="row">
                                                    ...
                                                    <!--/span-->
                                                    <div class="col-md-6">
                                                        <label class="control-label mb-10" for="date_entre">Date Entree</label>
                                            ...
                                            <!-- /Row -->
                                                <div class="row">
                                                    <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label mb-10" for="client_id">Catégorie Article</label>
